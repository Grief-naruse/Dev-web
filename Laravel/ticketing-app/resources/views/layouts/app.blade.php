...
<body>
    ...
    <aside class="sidebar">
        <h2 style="padding-bottom: 20px; border-bottom: 1px solid #34495e; text-align: center; margin-bottom: 0;">
            ERP
        </h2>
        ...
        <nav style="flex: 1;">
            <ul>
                ...
                @if(Auth::user()->isAdmin())
                    ...
                    <li><a href="{{ route('users.index') }}">👥 Gestion des Accès</a></li>
                @endif
            ...
            <div style="background-color: rgba(0,0,0,0.2); padding: 15px; border-radius: 8px;">
                <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
                    <div
                        style="width: 40px; height: 40px; border-radius: 50%; background-color: rgba(255,255,255,0.1); border: 2px solid #ecf0f1; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 1.1rem; overflow: hidden;">
                        @if(Auth::user()->avatar)
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit" class="btn btn-danger"
                        style="width: 100%; padding: 8px; font-size: 0.85rem;">🗑️ Déconnexion</button>
                </form>
            </div>
        </aside>
